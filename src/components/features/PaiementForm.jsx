      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            ...
            className={`flex flex-col items-center justify-center gap-2 p-4 rounded-xl border-2 transition-all ${modePayment === 'individuel'
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center gap-2 p-4 rounded-xl border-2 transition-all ${modePayment === 'famille'
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          {MONTANTS_RAPIDES.map((montant) => (
            <button
              ...
              className={`px-2 py-3 rounded-xl text-xs sm:text-sm font-bold transition-all active:scale-95 ${formData.montant === montant.toString()
        ...
        <div className="grid grid-cols-1 gap-2">
          {TYPES_PAIEMENT.map((type) => (
            <button
              ...
              className={`px-4 py-3 rounded-xl text-sm font-medium transition-all active:scale-95 ${formData.type === type
